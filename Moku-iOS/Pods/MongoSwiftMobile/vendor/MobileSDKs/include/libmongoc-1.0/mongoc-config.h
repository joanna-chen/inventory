...
#define MONGOC_USER_SET_CFLAGS "-arch armv7k -isysroot /Applications/Xcode9.2.0.app/Contents/Developer/Platforms/WatchOS.platform/Developer/SDKs/WatchOS4.2.sdk -mwatchos-version-min=4.2"
